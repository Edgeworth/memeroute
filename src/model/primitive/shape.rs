...
use crate::model::geom::intersects::{
    circ_intersect_rt, line_intersects_line, line_intersects_seg, path_intersects_rt,
    poly_intersects_rt, rt_intersects_rt, rt_intersects_seg, rt_intersects_tri, seg_intersects_seg,
};
